...
Jlam = RooRealVar("Jlam", "Jlam", 11.8, 5, 20)
Jgam = RooRealVar("Jgam", "Jgam", 0.13, -1, 1)
Jdel = RooRealVar("Jdel", "Jdel", 1.54, 0, 1.7)
Johnson = RooJohnson("Johnson","Johnson", D0_M, Jmu, Jlam, Jgam, Jdel)

# Gaussian
mean = RooRealVar("mean", "mean", 1865, 1860, 1870)
sigma = RooRealVar("sigma", "sigma", 6.6, 5, 10)
gauss = RooGaussian("Gaussian", "Gaussian", D0_M, mean, sigma)

# Bifurcated Gaussian
bifurmean = RooRealVar("bifurmean", "bifurmean", 1.8652e+03, 1860, 1870)
sigmaL =  RooRealVar("sigmaL", "sigmaL", 7.3903e+00, 5, 10)
sigmaR = RooRealVar("sigmaR", "sigmaR", 7.5486e+00, 5, 10)
...
a0 = RooRealVar("a0", "a0", -0.003, -0.01, -0.0001)
...
# DO MagUp
frac_D0_up = RooRealVar("frac_D0_up", "frac_D0_up", 0.51, 0.35, 0.6)
frac_D0_up_2 = RooRealVar("frac_D0_up_2", "frac_D0_up_2", 0.2, 0.1, 1)
# D0 MagDown
frac_D0_down = RooRealVar("frac_D0_down", "frac_D0_down", 0.57, 0.35, 0.6)
frac_D0_down_2 = RooRealVar("frac_D0_down_2", "frac_D0_down_2", 0.2, 0, 1)
# D0bar MagUp2
frac_D0bar_up = RooRealVar("frac_D0bar_up", "frac_D0bar_up", 0.49, 0.35, 0.6)
frac_D0bar_up_2 = RooRealVar("frac_D0bar_up_2", "frac_D0bar_up_2", 0.2, 0, 1)
# D0bar MagDown
frac_D0bar_down = RooRealVar("frac_D0bar_down", "frac_D0bar_down", 0.57, 0.35, 0.6)
frac_D0bar_down_2 = RooRealVar("frac_D0bar_down_2", "frac_D0bar_down_2", 0.2, 0, 0.5)
...
if binned:
    ...
    signal_D0_up = RooAddPdf("signal_D0_up", "signal D0 up", RooArgList(Johnson, bifurgauss, gauss), RooArgList(frac_D0_up, frac_D0_up_2))
    ...
    signal_D0_down = RooAddPdf("signal_D0_down", "signal D0 down", RooArgList(Johnson, bifurgauss, gauss), RooArgList(frac_D0_down, frac_D0_down_2))
    ...
    signal_D0bar_up = RooAddPdf("signal_D0bar_up", "signal D0bar up", RooArgList(Johnson, bifurgauss, gauss), RooArgList(frac_D0bar_up, frac_D0bar_up_2))
    ...
    signal_D0bar_down = RooAddPdf("signal_D0bar_down", "signal D0bar down", RooArgList(Johnson, bifurgauss, gauss), RooArgList(frac_D0bar_down, frac_D0bar_down_2))
