...
mkdir $directory"/binned_data"/$year
mkdir $directory"/binned_data"/$year/"local"
mkdir $directory"/binned_data"/$year/"pT"
mkdir $directory"/binned_data"/$year/"eta"
...
#             --meson $meson \
#             --polarity $polar \
#             --path $directory"/binned_data/"$year \
