...
--input /eos/lhcb/user/l/lseelan/Total/binned_data/${1:2:2}/local/both/${2:3}_${1:2:2}_70_bin${bin}.root:D02Kpi_Tuple/DecayTree \
--output-directory /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/ --overwrite
...
--input /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/data.root \
--kpipi-input /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/temp_kpipi.root \
--kspi-input /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/temp_kspi.root \
--output-directory /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/ --overwrite
...
for mode in {kpipi,kspi}; do
  ...
  --input /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/temp_${mode}.root \
  --control-mode ${mode} \
  --output-directory /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/${mode}/ \
  --polarity $2
done


rm /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/data.root
rm /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/temp_kpipi.root
rm /eos/lhcb/user/s/sjtaylor/D0_asymmetry/Adet/local/$1/$2/${bin}/temp_kspi.root
